...
namespace RefactoringGuru.DesignPatterns.AbstractFactory.Conceptual
{
    ...
    public abstract class IAbstractProductA
    {
        public abstract string UsefulFunctionA() ;
    }

    // Concrete Products are created by corresponding Concrete Factories.
    class ConcreteProductA1 : IAbstractProductA
    {
        public override string UsefulFunctionA()
        {
    ...
    public abstract class IAbstractProductB
    {
        ...
        public abstract string UsefulFunctionB();

        // ...but it also can collaborate with the ProductA.
        //
        // The Abstract Factory makes sure that all products it creates are of
        // the same variant and thus, compatible.
        public abstract string AnotherUsefulFunctionB(IAbstractProductA collaborator) ;
    }

    // Concrete Products are created by corresponding Concrete Factories.
    class ConcreteProductB1 : IAbstractProductB
    {
        public override string UsefulFunctionB()
        {
        ...
        public override string AnotherUsefulFunctionB(IAbstractProductA collaborator)
        {
    ...
    class Client
    {
        public void Main()
        {
            ...
            ClientMethod(ConcreteFactory1.getInstance());
            Console.WriteLine();
